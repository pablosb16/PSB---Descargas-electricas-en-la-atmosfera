# -*- coding: utf-8 -*-
"""
Created on Wed Mar 12 10:30:47 2025
...
base_directory = r'C:/Users/Usuario/Desktop/Día 12 03'
...
# Buscar todas las carpetas que empiecen con "Datos12.03 Serie"
series_folders = [f for f in os.listdir(base_directory) if f.startswith("Datos12.03 Serie") and os.path.isdir(os.path.join(base_directory, f))]
...
for serie_folder in series_folders:
    ...
    sns.heatmap(corr_matrix, annot=False, cmap="Spectral", xticklabels=fft_dict.keys(), yticklabels=fft_dict.keys())
