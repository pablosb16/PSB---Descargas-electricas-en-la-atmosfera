...
base_directory = r'C:/Users/Usuario/Desktop/Datos 19 03 y 20 03/Datos18.03 Serie 92'
...
series_folders = [f for f in os.listdir(base_directory) if f.startswith("Datos13.03 Serie") and os.path.isdir(os.path.join(base_directory, f))]
