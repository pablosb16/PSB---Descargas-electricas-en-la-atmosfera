...
osc.write("*RST")  
osc.write("TIM:SCAL 1E-6")  # 1 µs/div para capturar el pulso del rayo
osc.write("CHAN1:SCAL 50E-3")  # 50 mV/div, ajusta según la señal
osc.write("FORM REAL")  
...
osc.write("TRIG:LEV 30E-3")  # Dispara cuando la señal supere 30 mV
...
tiempo_maximo = 10 * 60 * 60  # 10 horas en segundos
